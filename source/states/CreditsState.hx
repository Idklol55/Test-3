...
class CreditsState extends MusicBeatState
{
	...
	override function create()
	{
		...
		var defaultList:Array<Array<String>> = [ //Name - Icon name - Description - Link - BG Color
			['Mobile Porting Team'],
			['HomuHomu833',			'homura',				'Head Porter of Psych Engine Mobile',						'https://www.youtube.com/@HomuHomu833',	'FFE7C0'],
	...
	function pushModCreditsToList(folder:String)
	{
		...
		if (PsychFileSystem.exists(creditsFile))
		{
			var firstarray:Array<String> = PsychFile.getContent(creditsFile).split('\n');
			for(i in firstarray)
			{
